...
--
-- Host: localhost
-- Generation Time: Jul 28, 2014 at 04:28 PM
...
CREATE TABLE IF NOT EXISTS `department` (
  ...
  `key` int(11) NOT NULL DEFAULT '0' COMMENT '是否是重点学科（科室），0：非重点；1：重点',
...
INSERT INTO `department` (`id`, `name`, `desc`, `image`, `key`, `directorId`) VALUES
(1, '骨科', '骨科是各大医院最常见的科室之一，主要研究骨骼肌肉系统的解剖、生理与病理，运用药物、手术及物理方法保持和发展这一系统的正常形态与功能', NULL, 0, 0),
