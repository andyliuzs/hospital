...
--
-- Host: localhost
-- Generation Time: Aug 04, 2014 at 04:33 PM
...
CREATE TABLE IF NOT EXISTS `department` (
  ...
  `image` varchar(100) DEFAULT NULL COMMENT '科室图片url',
  `recommend` int(11) NOT NULL DEFAULT '0' COMMENT '是否是重点学科（科室），0：非重点；1：重点',
  `directorId` int(11) DEFAULT NULL COMMENT '主任ID',
  `sort` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='科室' AUTO_INCREMENT=11 ;
...
(11, 'fanyanqiu', 'fanyanqiu', '范彦秋', 2, 0, 0, 45, '1988年毕业于哈尔滨医科大学医学系，研究生学历，现任黑龙江省医学会消化内镜分会委员，佳木斯市医学会消化内镜分会副主任委员，2001年在北京友谊医院进修一年。熟练掌握消化系统急、危、重症病人的抢救治疗，上消化道出血的内镜下注射止血及钛夹止血治疗；肝硬化并食管静脉曲张出血的内镜下套扎止血治疗；胃石症的内镜下碎石治疗；胃肠息肉的内镜切除术及消化道异物取出术等。\r\n', 9, 0, 1, '/admin/uploads/avatar/1406124112441.gif', NULL),
...
(20, 'bichengjie', 'bichengjie', '毕成杰', 2, 1, 1, 55, '专业特长：应用中医中药及中西医结合治疗血液系统常见病及多发病', 6, 98, NULL, '\\upload\\avatar\\1407168721563.jpg', '1406475130166'),
(21, 'lizhi', 'lizhi', '李志', 2, 1, 1, 33, '从事血液科工作27年，专业范围是血液科疾病的治疗', 7, 97, NULL, '\\upload\\avatar\\1407168761154.gif', NULL),
(22, 'maliu', 'maliu', '马六', 2, 0, 1, 55, '的顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶', 1, 0, NULL, '\\upload\\avatar\\1406475076168.png', NULL);
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  `cid` int(11) NOT NULL COMMENT '公告分类的ID',
  `author` varchar(45) DEFAULT NULL COMMENT '公告作者',
  `del` int(11) DEFAULT '1' COMMENT '是否被删除（1：正常；0：被删除）',
...
CREATE TABLE IF NOT EXISTS `post_category` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='公告类别表' AUTO_INCREMENT=6 ;
