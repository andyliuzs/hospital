...
public class RegistValidator extends Validator {
	...
	protected void validate(Controller controller) {
		...
		validateRegex("user.account", "[a-zA-Z0-9_\\u4e00-\\u9fa5]{2,20}",
				"accountMsg", "请输入合法的账号介于2-20!");
		validateRegex("user.password", "[a-zA-Z0-9_]{6,12}", "passwordMsg",
				"密码的长度介于6-12之间，只能包含数字，字母，下划线");
		validateRegex("password2", "[a-zA-Z0-9_]{6,12}", "password2Msg",
				"密码的长度介于6-12之间，只能包含数字，字母，下划线");
		...
		// validateRegex("user.address", "[a-zA-Z0-9_\\u4e00-\\u9fa5]{6,100}",
		// "addressMsg", "地址的的长度介于6-100之间，只能包含中文，数字，字母，下划线");
